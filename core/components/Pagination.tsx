...
// * utils
import { extractPagination } from '@/core/utils/pagination';

// * icons
import { IconChevronLeft, IconChevronRight } from '@tabler/icons-react';

// * types
import type { SidebarTree } from '@/core/utils/sidebar';
...
const Pagination = ({ sidebarTree, pagePath }: PaginationProps) => {
  ...
  return (
    <footer className='mt-10 grid grid-cols-2 gap-4 capitalize'>
      {prevPage.href && (
